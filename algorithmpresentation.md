# Algorithm
## Definition:
A **algorithm** is [a set of finite, well-defined steps or instructions designed to solve a problem or perform a computation.](https://www.geeksforgeeks.org/dsa/introduction-to-algorithms/)
...
There are 3 things about algorithms that needs to be analyzed.

1.Efficiency
- How fast the algorithm runs

2.Scalability
- How well the algorithm performs when the input size becomes large
